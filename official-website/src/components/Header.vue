  ...
  >
    <div class="container">
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <button
          @click="toggleMenu"
          class="md:hidden p-3 -mr-2 rounded-lg hover:bg-gray-100 transition-colors active:scale-95 relative z-[80]"
    ...
    >
      <div
        v-if="isMenuOpen"
        class="fixed top-0 right-0 bottom-0 w-72 max-w-[85vw] bg-white z-[70] md:hidden shadow-2xl overflow-y-auto"
      >
        <div class="p-6">
          <!-- Mobile Header -->
          <div class="flex items-center justify-between mb-8">
            ...
            <button
              @click="toggleMenu"
              class="p-2 -mr-2 rounded-lg hover:bg-gray-100 transition-colors active:scale-95"
          ...
          <div class="space-y-2">
            <RouterLink
              ...
              :key="item.name"
              :to="item.href"
              class="flex items-center px-4 py-4 rounded-xl hover:bg-gray-50 transition-colors font-medium text-lg touch-manipulation"
          ...
          <div class="mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="flex items-center justify-center px-6 py-4 rounded-xl bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-medium text-lg hover:shadow-lg transition-shadow touch-manipulation"
              @click="toggleMenu"
            >
          ...
          <div class="mt-8 pt-8 border-t border-gray-200">
            ...
            <div class="flex space-x-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors touch-manipulation"
              >

<template>
  <div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8">
      ...
      <div class="space-y-6">
        <div>
          <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">个人资料</h2>
        ...
        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div class="flex gap-4">
            ...
            >
              ...
              <div class="text-sm font-medium text-gray-900 dark:text-white">浅色</div>
            </button>
            <button
            ...
            >
              ...
              <div class="text-sm font-medium text-gray-900 dark:text-white">深色</div>
            </button>
          </div>
        </div>

        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">账号信息</h2>
          <div class="space-y-3">
            <div>
              ...
              <input
                ...
                disabled
                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white cursor-not-allowed"
              />
            </div>
            <div>

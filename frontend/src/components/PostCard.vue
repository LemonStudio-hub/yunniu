    ...
    <div class="relative p-6">
      <div class="flex items-start gap-4">
        <div class="flex-shrink-0">
          <div class="relative">
            <img
              :src="post.authorAvatar || getDefaultAvatar(post.authorUsername || '')"
              :alt="post.authorUsername"
              class="w-12 h-12 rounded-full object-cover ring-2 ring-gray-200 dark:ring-gray-600 ring-offset-2 ring-offset-white dark:ring-offset-gray-800 group-hover:ring-primary-400 dark:group-hover:ring-primary-500 transition-all duration-400 group-hover:scale-110"
            />
            <div class="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-gradient-to-br from-green-400 to-green-500 border-2 border-white dark:border-gray-800 rounded-full shadow-sm"></div>
          </div>
        </div>
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-2.5">
            <router-link
              ...
              class="text-sm font-semibold text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors hover:underline underline-offset-4 decoration-primary-400/50 hover:decoration-primary-400"
            >
              {{ post.authorUsername }}
            </router-link>
          ...
          <router-link
            ...
            class="block group"
          >
            <h2 class="text-xl font-display font-bold text-gray-900 dark:text-white group-hover:text-gradient-simple transition-all duration-400 mb-2.5 leading-tight group-hover:scale-[1.02]">
              {{ post.title }}
            </h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 leading-relaxed mb-4 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
              {{ post.content }}
            </p>
          </router-link>
